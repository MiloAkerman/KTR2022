...
public class Constants {
    ...
    public static int[] MINER_SPAWN_BOUNDS = new int[] { 2, 29 };
    public static int[] SOLDIER_SPAWN_BOUNDS = new int[] { 96, 35 };
    public static int[] REG_BUILDER_SPAWN_BOUNDS = new int[] { 1, 6, 20 };
    public static int[] SUICIDE_BUILDER_SPAWN_BOUNDS = new int[] { 2, 30, 30 };

    public static int[] LAB_POST_CHANCE = new int[] { 15, 4 };
    public static double SIGMOID_LAB_A = -0.19;

    public static int[] SOLDIER_RUSH_BOUNDS = new int[] { 2, 6 };
