...
//TODO: better watchtowers/labs, remove soldiers(?)
public class Archon extends Unit {
    ...
    static boolean sagerush = false;
    static boolean lowlead = false;
    ...
    public static void run() throws GameActionException {
        ...
        // post lab job
        if((betterArchonID == 0 && spawnTurnCount == 1) || ((totalSpawns%labSpawnChance==labSpawnChance-1) && getReservedLead() <= 360)) {
            ...
            int x = trueRng.nextInt(10)-5;
            int y = trueRng.nextInt(10)-5;
    ...
    public static RobotType getBestSpawn() throws GameActionException {
        ...
        } else if (turnCount < 10 || spawn <= minerSpawn) {
